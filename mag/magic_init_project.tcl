...
# ------------------------------------------------
set TOP_LEVEL_CELL     tt_um_LPCAS_TP1
set TEMPLATE_FILE      tt_analog_1x2_3v3.def
set POWER_STRIPE_WIDTH 4um                 ;# The minimum width is 1.2um
...
cellname rename tt_um_LPCAS_TP1 $TOP_LEVEL_CELL
...
file mkdir gds
gds write ../gds/tt_um_LPCAS_TP1.gds
file mkdir lef
lef write lef/tt_um_LPCAS_TP1.lef -pinonly
